...
const ViewAllQuestions = () => {
  ...
  const fetchQuestions = () => {
    axios.get(`https://d6tqiw98kb.execute-api.us-east-1.amazonaws.com/dev/all-questions`)
          ...
          <ListItem disablePadding key={index}>
            <ListItemButton>
              ...
              <ListItemSecondaryAction>
                ...
                <IconButton edge="end"  aria-label="edit" onClick={() => navigate(`/update-question/${questionObj.category}/id/${questionObj.id}`)}> 
                  <EditIcon />  
                </IconButton>
              </ListItemSecondaryAction>
            </ListItemButton>
